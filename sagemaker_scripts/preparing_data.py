...
def preparing_data():
    ...
    data_container = Dataloader("./data/en-fr.csv", allowed_chars=allowed_chars)
    ...
    tok.tokenize(df, src_tokenizer_regex, tgt_tokenizer_regex)
    prune_and_padding_for_transformer(df, 200)
    df.to_parquet("./data/en-fr_5M_len200.parquet", engine="pyarrow")
